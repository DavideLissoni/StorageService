...
public class BmiHistory implements Serializable{
	...
	//Database operations
		// get the BmiHistory which id correspond to the given id as parameter, return a
		// BmiHistory
		...
		public static BmiHistory getBmiHistoryByDate(String date) {
			...
			try {
				Query q = em.createQuery(
						"SELECT b FROM BmiHistory b WHERE b.date>:date order by b.date asc",
						BmiHistory.class);
				...
				System.out.println(
						"The database doesn't contain a BmiHistory with the date required");
